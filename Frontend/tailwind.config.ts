    ...
    extend: {
      colors: {
        ...
        primary: {
          ...
          300: '#7dd3ff',
          400: '#38bdf8',
          500: '#0ea5e9', // Azul clínico principal
          600: '#0284c7',
          700: '#0369a1',
          800: '#075985',
          900: '#0c3d66',
        ...
        // Alias para uso más intuitivo
        success: 'var(--color-success, rgb(34, 197, 94))',
        warning: 'var(--color-warning, rgb(251, 146, 60))',
        error: 'var(--color-error, rgb(239, 68, 68))',
        info: 'var(--color-info, rgb(14, 165, 233))',
      },
      fontFamily: {
