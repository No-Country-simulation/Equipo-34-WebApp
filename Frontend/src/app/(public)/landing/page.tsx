...
import NavIndicator from '@/shared/components/nav/NavIndicator';

function HeroSection({ t, router }: { readonly t: ReturnType<typeof useTranslations>, readonly router: ReturnType<typeof useRouter> }) {
  return (
    <section id="hero" className="mx-auto max-w-6xl px-4 py-20 h-[1024px]">
...
function WhyChooseSection({ t }: { readonly t: ReturnType<typeof useTranslations> }) {
  return (
    <section id="why-choose" className="bg-white dark:bg-gray-900 py-20 transition-colors h-[1024px]">
...
function CTASection({ t, router }: { readonly t: ReturnType<typeof useTranslations>, readonly router: ReturnType<typeof useRouter> }) {
  return (
    <section id="cta" className="mx-auto max-w-6xl px-4 py-20 text-center h-[1024px]">
...
function FooterSection({ t }: { readonly t: ReturnType<typeof useTranslations> }) {
  return (
...
export default function LandingPage() {
  ...
  const sections = [
    ...
    { id: 'why-choose', label: t('landing.whyChoose.title') },
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors">
      ...
      <NavIndicator sections={sections} />
      {/* Navbar */}
